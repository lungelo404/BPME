...
<xpdl2:Package xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:database="http://www.tibco.com/XPD/database1.0.0" xmlns:eaijava="http://www.tibco.com/XPD/EAIJava1.0.0" xmlns:email="http://www.tibco.com/XPD/email1.0.0" xmlns:iProcessExt="http://www.tibco.com/XPD/iProcessExt1.0.0" xmlns:orchestrator="http://www.tibco.com/XPD/orchestrator1.0.0" xmlns:order="http://www.tibco.com/XPD/order1.0.0" xmlns:xpdExt="http://www.tibco.com/XPD/xpdExtension1.0.0" xmlns:xpdl2="http://www.wfmc.org/2008/XPDL2.1" xsi:schemaLocation="http://www.wfmc.org/2008/XPDL2.1 http://www.wfmc.org/standards/bpmnxpdl_31.xsd" Id="_default_fragment_id" xpdExt:DisplayName="fragment" Name="fragment">
...
if (data.caseRefType != null){&#xD;
	data.caseBomType = bpm.caseData.read(data.caseRefType);&#xD;
}</xpdl2:Script>
              </xpdl2:TaskScript>
            </xpdl2:Task>
          </xpdl2:Implementation>
      ...
      <xpdl2:Transitions>
        ...
        <xpdl2:Transition Id="_u3ZeICReEeS7nfcnWLEGQg" xpdExt:DisplayName="" Name="" From="_EBEqlhf-EeS249Me-D-Z1Q" To="_uFPocCReEeS7nfcnWLEGQg">
          <xpdl2:Condition Type="CONDITION">
                        ...
                        <xpdl2:Expression ScriptGrammar="JavaScript">data.caseBomType == null;</xpdl2:Expression>
